...
public class MailUtil {
    ...
    public String sendMail(final String mailTo, final String mailFrom, final String password, final String mailSubject, final StringBuilder mailMessage) {
    String str="";
     ...
     //   SecurityManager security = System.getSecurityManager();
        ...
        try {
           ...
           // System.out.print("hhhhhhhhh"+mex.getClass());
           // System.out.print("llllllllllllllllll"+mex.toString());
            mex.getMessage();
            mex.printStackTrace();
            str=""+mex;
...
//    	  .append("<ul>")
//    	  .append("<li>Username: <a href='mailto:user1@nidhishkrishnan.gmail.com' target='_blank'>user1@nidhishkrishnan.gmail.<wbr>com</a>")
//    	  .append("</li>")
//    	  .append("<li>Password: 1occaecativolupta1</li>")
//    	  .append("</ul>")
...
// 
//    	 
//		new MailUtil().sendMail("mpriyaus@yahoo.in", "smartbanking.codechef@gmail.com", "try123456", "Congratulations! Your Smart Bank account has been activated.", stringBuilder);
//	}

	public void sendCredentialsAsEmail(final String email, final String userName, final String password) {
		final StringBuilder message = getEmailMessage(userName, password);
	...
	private StringBuilder getEmailMessage(final String userName, final String password) {
